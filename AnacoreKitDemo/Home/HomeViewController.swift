...
class HomeViewController: JRARootVC {
    ...
    private lazy var welcomeLabel: JRALabel = {
        let label = JRALabel(text: "Welcome")
        label.size = JRASharedConfigContainer.shared.styleConfig.xxlFontSize
        return label
    }()
    
    private lazy var versionLabel: JRABorderLabel = {
        let border = JRABorderLabel(text: "v0.0.1")
        border.label.size = JRASharedConfigContainer.shared.styleConfig.sFontSize
        border.spaceConstraint.setSpacing(top: 5, right: 10, bottom: 5, left: 10)
        border.backgroundColor = JRASharedConfigContainer.shared.styleConfig.infoColor
        border.label.textColor = JRASharedConfigContainer.shared.styleConfig.secondaryColor
    ...
    private lazy var demoLabel: JRALabel = {
        ...
        label.size = JRASharedConfigContainer.shared.styleConfig.sFontSize
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.backgroundColor = JRASharedConfigContainer.shared.styleConfig.background
